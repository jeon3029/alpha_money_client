        ...
        saveButton.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                if(editTextDate.getText().toString().equals("111")) {
                    ...
                    ApplicationSingleton.getInstance().onInsertdata("20160904", "3700", "미니스톱", "10", "", "", "", "NH(8*7*)", 1);
                    ApplicationSingleton.getInstance().onInsertdata("20160804", "78700", "연어상회", "10", "", "", "", "KB(5*8*)", 1);
                    ApplicationSingleton.getInstance().onInsertdata("20160728", "13000", "맘스터치", "10", "", "", "", "NH(8*7*)", 1);
                    ApplicationSingleton.getInstance().onInsertdata("20160630", "44000", "오버워치", "30", "", "", "", "신한(4*8*)", 1);
                    ApplicationSingleton.getInstance().onInsertdata("20160522", "30000", "윤씨밀방", "10", "", "", "", "신한(4*8*)", 1);
                    ApplicationSingleton.getInstance().onInsertdata("20160513", "34500", "에버랜드", "31", "", "", "", "신한(4*8*)", 1);
                    ApplicationSingleton.getInstance().onInsertdata("20160501", "7500", "리소헤어", "34", "", "", "", "신한(4*8*)", 1);
                    ApplicationSingleton.getInstance().onInsertdata("20160416", "88000", "클럽A", "30", "", "", "", "NH(8*7*)", 1);
                    ApplicationSingleton.getInstance().onInsertdata("20160330", "19000", "게임현질", "30", "", "", "", "신한(4*8*)", 1);
                    ApplicationSingleton.getInstance().onInsertdata("20160211", "200000", "A랜드", "33", "", "", "", "NH(8*7*)", 1);
                    ApplicationSingleton.getInstance().onInsertdata("20160101", "18000", "피자나라치킨공주", "10", "", "", "", "현금", 1);
                }
