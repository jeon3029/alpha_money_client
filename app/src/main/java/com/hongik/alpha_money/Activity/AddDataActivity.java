    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        saveButton.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                ApplicationSingleton.getInstance().onInsertdata("20161103","123","맘스터치","식사","","","",2);
                ApplicationSingleton.getInstance().onInsertdata("20161105","123","한가람","문구","","","",2);
                ApplicationSingleton.getInstance().onInsertdata("20161107","123","다이소","생활용품","","","",2);
                ApplicationSingleton.getInstance().onInsertdata("20161108","123","GIODANO","패션","","","",2);
                ApplicationSingleton.getInstance().onInsertdata("20161109","123","M&M","패션","","","",2);
                ApplicationSingleton.getInstance().onInsertdata("20161109","123","맥도날드","식사","","","",2);
                ApplicationSingleton.getInstance().onInsertdata("20161112","123","신선설농탕","식사","","","",2);
                ApplicationSingleton.getInstance().onInsertdata("20161114","123","Z:PC","엔터테인먼트","","","",2);
                ApplicationSingleton.getInstance().onInsertdata("20161114","123","연어상회","식사","","","",2);
                ApplicationSingleton.getInstance().onInsertdata("20161114","123","가게A","식사","","","",2);
                ApplicationSingleton.getInstance().onInsertdata("20161115","123","가게B","카페","","","",2);
                ApplicationSingleton.getInstance().onInsertdata("20161117","123","맛집","식사","","","",2);
                ApplicationSingleton.getInstance().onInsertdata("20161117","123","배고픔","식사","","","",2);
                ApplicationSingleton.getInstance().onInsertdata("20161118","123","이게뭐람","엔터테인먼트","","","",2);
                ApplicationSingleton.getInstance().onInsertdata("20161118","123","뻐꾸기","식사","","","",2);
                ApplicationSingleton.getInstance().onInsertdata("20161118","123","자옥이","패션","","","",2);
                ApplicationSingleton.getInstance().onInsertdata("20161118","123","필통","문구","","","",2);
                ApplicationSingleton.getInstance().onInsertdata("20161119","123","아메리카노큰거","카페","","","",2);
                ApplicationSingleton.getInstance().onInsertdata("20161119","123","갤6","전자제품","","","",2);
                ApplicationSingleton.getInstance().onInsertdata("20161120","123","모니터","전자제품","","","",2);
                ApplicationSingleton.getInstance().onInsertdata("20161121","123","BOHEM편의점","생활용품","","","",2);
                ApplicationSingleton.getInstance().onInsertdata("20161102","123","롯데ID편의점","생활용품","","","",2);
                ApplicationSingleton.getInstance().onInsertdata("20161003","456","탁상시계","생활용품","","","",2);
                ApplicationSingleton.getInstance().onInsertdata("20161007","456","포스트잇","문구","","","",2);
                ApplicationSingleton.getInstance().onInsertdata("20160927","456","딱풀","문구","","","",2);
                ApplicationSingleton.getInstance().onInsertdata("20160930","456","하늘보리","엔터테인먼트","","","",2);
                ApplicationSingleton.getInstance().onInsertdata("20161001","456","두부집","식사","","","",2);
