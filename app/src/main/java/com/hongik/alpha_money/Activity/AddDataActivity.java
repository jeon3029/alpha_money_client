    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        saveButton.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                ApplicationSingleton.getInstance().onInsertdata("20161103","38000","맘스터치","10","","","","NH(8070)",1);
                ApplicationSingleton.getInstance().onInsertdata("20161105","2300","한가람","20","","","","NH(8070)",1);
                ApplicationSingleton.getInstance().onInsertdata("20161107","10300","다이소","20","","","","NH(8070)",1);
                ApplicationSingleton.getInstance().onInsertdata("20161108","36400","GIODANO","35","","","","NH(8070)",1);
                ApplicationSingleton.getInstance().onInsertdata("20161109","5300","M&M","35","","","","NH(8070)",1);
                ApplicationSingleton.getInstance().onInsertdata("20161109","7600","맥도날드","10","","","","KB(5285)",1);
                ApplicationSingleton.getInstance().onInsertdata("20161112","15600","신선설농탕","11","","","","KB(5285)",1);
                ApplicationSingleton.getInstance().onInsertdata("20161114","34700","Z:PC","10","","","","NH(8070)",1);
                ApplicationSingleton.getInstance().onInsertdata("20161114","78700","연어상회","10","","","","KB(5285)",1);
                ApplicationSingleton.getInstance().onInsertdata("20161114","1300","가게A","10","","","","NH(8070)",1);
                ApplicationSingleton.getInstance().onInsertdata("20161115","65800","가게B","12","","","","신한체크(4885)",1);
                ApplicationSingleton.getInstance().onInsertdata("20161117","14000","맛집","10","","","","신한체크(4885)",1);
                ApplicationSingleton.getInstance().onInsertdata("20161117","34500","배고픔","11","","","","신한체크(4885)",1);
                ApplicationSingleton.getInstance().onInsertdata("20161118","4700","이게뭐람","30","","","","신한체크(4885)",1);
                ApplicationSingleton.getInstance().onInsertdata("20161118","46000","뻐꾸기","10","","","","NH(8070)",1);
                ApplicationSingleton.getInstance().onInsertdata("20161118","12300","자옥이","20","","","","신한체크(4885)",1);
                ApplicationSingleton.getInstance().onInsertdata("20161118","200","필통","21","","","","NH(8070)",1);
                ApplicationSingleton.getInstance().onInsertdata("20161119","6400","아메리카노큰거","12","","","","신한체크(4885)",1);
                ApplicationSingleton.getInstance().onInsertdata("20161119","15600","갤6","22","","","","신한체크(4885)",1);
                ApplicationSingleton.getInstance().onInsertdata("20161120","98700","모니터","22","","","","신한체크(4885)",1);
                ApplicationSingleton.getInstance().onInsertdata("20161121","3400","BOHEM편의점","21","","","","NH(8070)",1);
                ApplicationSingleton.getInstance().onInsertdata("20161102","35600","롯데ID편의점","21","","","","신한체크(4885)",1);
                ApplicationSingleton.getInstance().onInsertdata("20161003","13000","탁상시계","21","","","","NH(8070)",1);
                ApplicationSingleton.getInstance().onInsertdata("20161007","6800","포스트잇","21","","","","NH(8070)",1);
                ApplicationSingleton.getInstance().onInsertdata("20160927","3800","딱풀","22","","","","신한체크(4885)",1);
                ApplicationSingleton.getInstance().onInsertdata("20160930","45300","하늘보리","32","","","","NH(8070)",1);
                ApplicationSingleton.getInstance().onInsertdata("20161001","156000","두부집","10","","","","신한체크(4885)",1);
                ApplicationSingleton.getInstance().onInsertdata("20161012","2600","옛집","10","","","","NH(8070)",1);
                ApplicationSingleton.getInstance().onInsertdata("20161013","5800","순대국집","12","","","","NH(8070)",1);
                ApplicationSingleton.getInstance().onInsertdata("20161003","13000","와끝이다","00","","","","NH(8070)",1);
